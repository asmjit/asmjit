...
#ifndef ASMJIT_TESTING_COMMONS_ASMJIT_UTILS_H_INCLUDED
#define ASMJIT_TESTING_COMMONS_ASMJIT_UTILS_H_INCLUDED
...
#endif // ASMJIT_TESTING_COMMONS_ASMJIT_UTILS_H_INCLUDED
