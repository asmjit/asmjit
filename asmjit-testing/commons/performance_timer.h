...
#ifndef ASMJIT_TESTING_COMMONS_PERFORMANCE_TIMER_H_INCLUDED
#define ASMJIT_TESTING_COMMONS_PERFORMANCE_TIMER_H_INCLUDED
...
#endif // ASMJIT_TESTING_COMMONS_PERFORMANCE_TIMER_H_INCLUDED
