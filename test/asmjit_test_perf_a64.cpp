...
static void generateGpSequenceInternal(
  ...
  cc.ccmn(wA, wB, 3, Cond::kEQ);
  cc.ccmn(xA, xB, 3, Cond::kEQ);
  cc.ccmn(wA, 2, 3, Cond::kEQ);
  cc.ccmn(xA, 2, 3, Cond::kEQ);
  cc.ccmn(wA, wzr, 3, Cond::kEQ);
  cc.ccmn(xA, xzr, 3, Cond::kEQ);
  cc.ccmp(wA, wB, 3, Cond::kEQ);
  cc.ccmp(xA, xB, 3, Cond::kEQ);
  cc.ccmp(wA, 2, 3, Cond::kEQ);
  cc.ccmp(xA, 2, 3, Cond::kEQ);
  cc.ccmp(wA, wzr, 3, Cond::kEQ);
  cc.ccmp(xA, xzr, 3, Cond::kEQ);
  cc.cinc(wA, wB, Cond::kEQ);
  cc.cinc(xA, xB, Cond::kEQ);
  cc.cinc(wzr, wB, Cond::kEQ);
  cc.cinc(wA, wzr, Cond::kEQ);
  cc.cinc(xzr, xB, Cond::kEQ);
  cc.cinc(xA, xzr, Cond::kEQ);
  cc.cinv(wA, wB, Cond::kEQ);
  cc.cinv(xA, xB, Cond::kEQ);
  cc.cinv(wzr, wB, Cond::kEQ);
  cc.cinv(wA, wzr, Cond::kEQ);
  cc.cinv(xzr, xB, Cond::kEQ);
  cc.cinv(xA, xzr, Cond::kEQ);
  cc.cls(wA, wB);
  cc.cls(xA, xB);
  cc.cls(wA, wzr);
  cc.cls(xA, xzr);
  ...
  cc.crc32x(wA, wzr, xC);
  cc.crc32x(wA, wB, xzr);
  cc.csel(wA, wB, wC, Cond::kEQ);
  cc.csel(xA, xB, xC, Cond::kEQ);
  cc.cset(wA, Cond::kEQ);
  cc.cset(xA, Cond::kEQ);
  cc.cset(wA, Cond::kEQ);
  cc.cset(xA, Cond::kEQ);
  cc.csetm(wA, Cond::kEQ);
  cc.csetm(xA, Cond::kEQ);
  cc.csinc(wA, wB, wC, Cond::kEQ);
  cc.csinc(xA, xB, xC, Cond::kEQ);
  cc.csinv(wA, wB, wC, Cond::kEQ);
  cc.csinv(xA, xB, xC, Cond::kEQ);
  cc.csneg(wA, wB, wC, Cond::kEQ);
  cc.csneg(xA, xB, xC, Cond::kEQ);
  cc.eon(wA, wB, wC);
  cc.eon(wzr, wB, wC);
  cc.eon(wA, wzr, wC);
  cc.eon(wA, wB, wzr);
...
static void benchmarkA64Function(uint32_t arch, uint32_t numIterations, const char* description, const EmitterFn& emitterFn) noexcept {
  CodeHolder code;
  printf("%s:\n", description);
...
void benchmarkA64Emitters(uint32_t numIterations) {
  ...
  benchmarkA64Function(Environment::kArchAArch64, numIterations, description, [](BaseEmitter& emitter, bool emitPrologEpilog) {
