...
#ifndef ASMJIT_X86_X86_EMITTER_H_INCLUDED
#define ASMJIT_X86_X86_EMITTER_H_INCLUDED
...
public:
  ...
  //! Use REPNE prefix.
  //!
  //! \note This is the same as using `repnz()` prefix.
  ...
  //! Use REPNE prefix.
  //!
  //! \note This is the same as using `repne()` prefix.
...
#endif // ASMJIT_X86_X86_EMITTER_H_INCLUDED
