...
#ifndef ASMJIT_X86_X86_ASSEMBLER_H_INCLUDED
#define ASMJIT_X86_X86_ASSEMBLER_H_INCLUDED
...
//!   frame.set_dirty_regs(RegGroup::kVec, axl::bit_mask<RegMask>(0, 1));
//!
...
//! }
//! ```
class ASMJIT_VIRTAPI Assembler final
...
#endif // ASMJIT_X86_X86_ASSEMBLER_H_INCLUDED
