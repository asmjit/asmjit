...
#ifndef ASMJIT_X86_X86_ARCH_TRAITS_P_H_INCLUDED
#define ASMJIT_X86_X86_ARCH_TRAITS_P_H_INCLUDED
...
static const constexpr ArchTraits x86_arch_traits = {
  ...
  // Instruction hints [Gp, Vec, Mask/K, Extra/MMX].
  {{ InstHints::kRegSwap | InstHints::kPushPop, InstHints::kNoHints, InstHints::kNoHints, InstHints::kNoHints }},
  ...
  { ArchTypeNameId::kDB, ArchTypeNameId::kDW, ArchTypeNameId::kDD, ArchTypeNameId::kDQ }
};
...
#endif // ASMJIT_X86_X86_ARCH_TRAITS_P_H_INCLUDED
