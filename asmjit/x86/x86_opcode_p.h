...
#ifndef ASMJIT_X86_X86_OPCODE_P_H_INCLUDED
#define ASMJIT_X86_X86_OPCODE_P_H_INCLUDED
...
struct Opcode {
  ...
  template<typename T>
  ASMJIT_INLINE_NODEBUG Opcode& force_evex_if(T exp) noexcept { return operator|=(uint32_t(exp) << axl::ctz(uint32_t(kMM_ForceEvex))); }
...
#endif // ASMJIT_X86_X86_OPCODE_P_H_INCLUDED
