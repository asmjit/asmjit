...
#ifndef ASMJIT_UJIT_UJIT_BASE_P_H_INCLUDED
#define ASMJIT_UJIT_UJIT_BASE_P_H_INCLUDED
...
static ASMJIT_INLINE_NODEBUG VecWidth vec_width_of(VecWidth vw, DataWidth data_width, uint32_t n) noexcept {
  return VecWidth(axl::min<uint32_t>((n << uint32_t(data_width)) >> 5, uint32_t(vw)));
}
...
#endif // ASMJIT_UJIT_UJIT_BASE_P_H_INCLUDED
