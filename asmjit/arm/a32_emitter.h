...
#ifndef ASMJIT_ARM_A32_EMITTER_H_INCLUDED
#define ASMJIT_ARM_A32_EMITTER_H_INCLUDED
...
struct EmitterExplicitT {
  ...
  static inline constexpr uint32_t kCCShift = axl::ctz(InstIdParts::kARM_Cond);
  static inline constexpr uint32_t kDT1Shift = axl::ctz(InstIdParts::kA32_DT);
  static inline constexpr uint32_t kDT2Shift = axl::ctz(InstIdParts::kA32_DT2);
...
#endif // ASMJIT_ARM_A32_EMITTER_H_INCLUDED
