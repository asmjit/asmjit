...
#ifndef ASMJIT_ARM_A64_ARCH_TRAITS_P_H_INCLUDED
#define ASMJIT_ARM_A64_ARCH_TRAITS_P_H_INCLUDED
...
static const constexpr ArchTraits a64_arch_traits = {
  ...
  {{ InstHints::kPushPop, InstHints::kPushPop, InstHints::kNoHints, InstHints::kNoHints }},
  ...
  { ArchTypeNameId::kByte, ArchTypeNameId::kHWord, ArchTypeNameId::kWord, ArchTypeNameId::kXWord }
};
...
#endif // ASMJIT_ARM_A64_ARCH_TRAITS_P_H_INCLUDED
