...
#ifndef ASMJIT_ARM_A64_EMIT_HELPER_P_H_INCLUDED
#define ASMJIT_ARM_A64_EMIT_HELPER_P_H_INCLUDED
...
class EmitHelper final : public BaseEmitHelper {
public:
...
[[maybe_unused]]
static inline void update_emitter_funcs(BaseEmitter* emitter) noexcept { axl::maybe_unused(emitter); }
...
#endif // ASMJIT_ARM_A64_EMIT_HELPER_P_H_INCLUDED
