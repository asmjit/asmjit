...
class MyListNode : public axl::ArenaListNode<MyListNode> {};

TEST_CASE(axl_arena_list) {
  axl::Arena arena(4096);
  axl::ArenaList<MyListNode> list;
  ...
  TEST_LOG("InsertAfter / InsertBefore");
