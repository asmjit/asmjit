...
#ifndef ASMJIT_AXL_ARENA_LIST_H_INCLUDED
#define ASMJIT_AXL_ARENA_LIST_H_INCLUDED
...
public:
  ...
  ASMJIT_INLINE_NODEBUG void swap(ArenaList& other) noexcept {
    axl::swap(_nodes[0], other._nodes[0]);
    axl::swap(_nodes[1], other._nodes[1]);
  }
...
#endif // ASMJIT_AXL_ARENA_LIST_H_INCLUDED
