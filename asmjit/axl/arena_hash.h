...
#ifndef ASMJIT_AXL_ARENA_HASH_H_INCLUDED
#define ASMJIT_AXL_ARENA_HASH_H_INCLUDED
...
public:
  ...
  inline void _swap(ArenaHashBase& other) noexcept {
    ...
    axl::swap(_buckets_count, other._buckets_count);
    axl::swap(_buckets_grow, other._buckets_grow);
    axl::swap(_rcp_value, other._rcp_value);
    axl::swap(_rcp_shift, other._rcp_shift);
    axl::swap(_prime_index, other._prime_index);
    axl::swap(_embedded[0], other._embedded[0]);
...
#endif // ASMJIT_AXL_ARENA_HASH_H_INCLUDED
