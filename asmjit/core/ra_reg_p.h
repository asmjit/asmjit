...
#ifndef ASMJIT_CORE_RA_REG_P_H_INCLUDED
#define ASMJIT_CORE_RA_REG_P_H_INCLUDED
...
public:
  ...
  axl::ArenaVector<BaseNode*> _refs {};
  //! All nodes that write to this VirtReg/WorkReg.
  axl::ArenaVector<BaseNode*> _writes {};
  ...
  axl::ArenaBitSet _immediate_consecutives {};
  ...
  [[nodiscard]]
  ASMJIT_INLINE_NODEBUG bool has_flag(RAWorkRegFlags flag) const noexcept { return axl::test(_flags, flag); }
  ...
  [[nodiscard]]
  ASMJIT_INLINE_NODEBUG bool has_multiple_use_ids() const noexcept { return axl::has_at_least_2_bits_set(_use_id_mask); }
  ...
  [[nodiscard]]
  ASMJIT_INLINE_NODEBUG const axl::ArenaBitSet& immediate_consecutives() const noexcept { return _immediate_consecutives; }

  [[nodiscard]]
  inline Error add_immediate_consecutive(axl::Arena& arena, RAWorkId work_id) noexcept {
...
#endif // ASMJIT_CORE_RA_REG_P_H_INCLUDED
