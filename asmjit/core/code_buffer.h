...
#ifndef ASMJIT_CORE_CODE_BUFFER_H_INCLUDED
#define ASMJIT_CORE_CODE_BUFFER_H_INCLUDED
...
public:
  ...
  size_t _capacity {};
  //! Buffer flags.
  CodeBufferFlags _flags = CodeBufferFlags::kNone;
  ...
  [[nodiscard]]
  ASMJIT_INLINE_NODEBUG bool has_flag(CodeBufferFlags flag) const noexcept { return axl::test(_flags, flag); }
...
#endif // ASMJIT_CORE_CODE_BUFFER_H_INCLUDED
