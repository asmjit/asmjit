...
#ifndef ASMJIT_CORE_COMPILER_DEFS_H_INCLUDED
#define ASMJIT_CORE_COMPILER_DEFS_H_INCLUDED
...
public:
  ...
  static constexpr inline uint32_t kAlignmentLog2Shift = axl::ctz(kAlignmentLog2Mask);
  ...
  [[nodiscard]]
  ASMJIT_INLINE_NODEBUG bool is_fixed() const noexcept { return axl::test(_reg_flags, VirtRegFlags::kIsFixed); }
  ...
  [[nodiscard]]
  ASMJIT_INLINE_NODEBUG bool is_stack_area() const noexcept { return axl::test(_reg_flags, VirtRegFlags::kIsStackArea); }
  ...
  [[nodiscard]]
  ASMJIT_INLINE_NODEBUG bool has_stack_slot() const noexcept { return axl::test(_reg_flags, VirtRegFlags::kHasStackSlot); }
...
#endif // ASMJIT_CORE_COMPILER_DEFS_H_INCLUDED
