...
#include <asmjit/core/misc_p.h>
  ...
  #include <asmjit/x86/x86_arch_traits_p.h>
#endif

#if !defined(ASMJIT_NO_AARCH32)
  #include <asmjit/arm/a32_arch_traits_p.h>
#endif

#if !defined(ASMJIT_NO_AARCH64)
  #include <asmjit/arm/a64_arch_traits_p.h>
#endif
...
static const constexpr ArchTraits no_arch_traits = {
  ...
  {{ InstHints::kNoHints, InstHints::kNoHints, InstHints::kNoHints, InstHints::kNoHints }},
  ...
  { ArchTypeNameId::kByte, ArchTypeNameId::kHalf, ArchTypeNameId::kWord, ArchTypeNameId::kQuad }
};
