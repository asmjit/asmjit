...
#ifndef ASMJIT_CORE_EMITTER_UTILS_P_H_INCLUDED
#define ASMJIT_CORE_EMITTER_UTILS_P_H_INCLUDED
...
static ASMJIT_INLINE_NODEBUG bool is_encodable_offset_32(int32_t offset, uint32_t num_bits) noexcept {
  ...
  return axl::sar(axl::shl(offset, n_rev), n_rev) == offset;
}
...
#endif // ASMJIT_CORE_EMITTER_UTILS_P_H_INCLUDED
