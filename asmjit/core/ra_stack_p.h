...
#ifndef ASMJIT_CORE_RA_STACK_P_H_INCLUDED
#define ASMJIT_CORE_RA_STACK_P_H_INCLUDED
...
public:
  ...
  //! Stack slots vector.
  axl::ArenaVector<RAStackSlot*> _slots;
  ...
  ASMJIT_INLINE_NODEBUG void reset(axl::Arena* arena) noexcept {
    _arena = arena;
    _bytes_used = 0;
    _stack_size = 0;
    _alignment = 1;
  ...
  [[nodiscard]]
  ASMJIT_INLINE_NODEBUG Span<RAStackSlot*> slots() noexcept { return _slots.span_mut(); }
...
#endif // ASMJIT_CORE_RA_STACK_P_H_INCLUDED
