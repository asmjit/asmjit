...
#ifndef ASMJIT_CORE_JIT_ALLOCATOR_H_INCLUDED
#define ASMJIT_CORE_JIT_ALLOCATOR_H_INCLUDED
...
public:
  ...
  public:
    ...
    ASMJIT_INLINE_NODEBUG void shrink(size_t new_size) noexcept { _size = axl::min(_size, new_size); }
...
#endif
#endif // ASMJIT_CORE_JIT_ALLOCATOR_H_INCLUDED
