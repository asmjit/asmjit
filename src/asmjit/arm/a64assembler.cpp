...
static const constexpr SizeOpMap sizeOpMap[InstDB::kVO_Count] = {
  { // kVO_V_B:
    SizeOpTable::kTableBin, SizeOp::kQ   , B(SizeOp::k00) | B(SizeOp::k00Q)
  },

  { // kVO_V_BH:
    SizeOpTable::kTableAny, SizeOp::kSzQS, B(SizeOp::k00) | B(SizeOp::k00Q) |
                                           B(SizeOp::k01) | B(SizeOp::k01Q)
  },
  ...
  { // kVO_V_HS:
    SizeOpTable::kTableAny, SizeOp::kSzQS, B(SizeOp::k01) | B(SizeOp::k01Q) |
                                           B(SizeOp::k10) | B(SizeOp::k10Q)
  },

  { // kVO_V_S:
    SizeOpTable::kTableAny, SizeOp::kQ   , B(SizeOp::k10) | B(SizeOp::k10Q)
  },

  { // kVO_V_B8H4:
    SizeOpTable::kTableAny, SizeOp::kSzQS, B(SizeOp::k00) |
                                           B(SizeOp::k01)
  },
  ...
  { // kVO_V_B8D1:
    SizeOpTable::kTableAny, SizeOp::kSzQ , B(SizeOp::k00) |
                                           B(SizeOp::k11S)
  },

  { // kVO_V_H4S2:
    SizeOpTable::kTableAny, SizeOp::kSzQS, B(SizeOp::k01) |
                                           B(SizeOp::k10)
  },

  { // kVO_V_B16:
    SizeOpTable::kTableBin, SizeOp::kQ   , B(SizeOp::k00Q)
  },

  { // kVO_V_B16H8:
    SizeOpTable::kTableAny, SizeOp::kSzQS, B(SizeOp::k00Q) |
                                           B(SizeOp::k01Q)
  },
  ...
  { // kVO_V_H8S4:
    SizeOpTable::kTableAny, SizeOp::kSzQS, B(SizeOp::k01Q) |
                                           B(SizeOp::k10Q)
  },

  { // kVO_V_S4:
    SizeOpTable::kTableAny, 0            , B(SizeOp::k10Q)
  },

  { // kVO_V_D2:
    SizeOpTable::kTableAny, 0            , B(SizeOp::k11Q)
  },

  { // kVO_SV_BHS:
    SizeOpTable::kTableAny, SizeOp::kSzQS, B(SizeOp::k00) | B(SizeOp::k00Q) | B(SizeOp::k00S) |
                                           B(SizeOp::k01) | B(SizeOp::k01Q) | B(SizeOp::k01S) |
                                           B(SizeOp::k10) | B(SizeOp::k10Q) | B(SizeOp::k10S)
  },

  { // kVO_SV_B8H4S2:
    SizeOpTable::kTableAny, SizeOp::kSzQS, B(SizeOp::k00) | B(SizeOp::k00S) |
                                           B(SizeOp::k01) | B(SizeOp::k01S) |
                                           B(SizeOp::k10) | B(SizeOp::k10S)
  },

  { // kVO_SV_HS:
    SizeOpTable::kTableAny, SizeOp::kSzQS, B(SizeOp::k01) | B(SizeOp::k01Q) | B(SizeOp::k01S) |
                                           B(SizeOp::k10) | B(SizeOp::k10Q) | B(SizeOp::k10S)
  },
...
Error Assembler::_emit(uint32_t instId, const Operand_& o0, const Operand_& o1, const Operand_& o2, const Operand_* opExt) {
  ...
  Error err;
  uint32_t options;
  uint32_t attributes = instId;

  CodeWriter writer(this);

  instId &= ~Inst::kAttributesMask;
