...
public:
  ...
  ASMJIT_INLINE_NODEBUG VecArray cloneAs(const Reg& reg) const noexcept { return cloneAs(reg.signature()); }
...
#if defined(ASMJIT_UJIT_X86)
  ASMJIT_INLINE_NODEBUG VecArray xmm() const noexcept { return cloneAs(OperandSignature{RegTraits<RegType::kVec128>::kSignature}); }
  ASMJIT_INLINE_NODEBUG VecArray ymm() const noexcept { return cloneAs(OperandSignature{RegTraits<RegType::kVec256>::kSignature}); }
  ASMJIT_INLINE_NODEBUG VecArray zmm() const noexcept { return cloneAs(OperandSignature{RegTraits<RegType::kVec512>::kSignature}); }
#endif
