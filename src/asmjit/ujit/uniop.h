...
enum class UniOpVV : uint32_t {
  ...
  kRoundHalfUpF32S,           //!< Scalar f32 round-half-up.
  kRoundHalfUpF64S,           //!< Scalar f64 round-half-up.
  kRoundHalfUpF32,            //!< Vector f32 round-half-up.
  kRoundHalfUpF64,            //!< Vector f64 round-half-up.
