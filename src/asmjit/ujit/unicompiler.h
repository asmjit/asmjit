...
public:
  ...
  //! Optimization flags.
  UniOptFlags _optFlags = UniOptFlags::kNone;
  ...
  asmjit::ZoneVector<VecConstData> _vecConsts;
  asmjit::ZoneVector<VecConstDataEx> _vecConstsEx;
  ...
  ASMJIT_API UniCompiler(BackendCompiler* cc, const CpuFeatures& features, UniOptFlags optFlags) noexcept;
  ...
  ASMJIT_INLINE_NODEBUG asmjit::ZoneAllocator* zoneAllocator() noexcept { return &cc->_allocator; }
  ...
  ASMJIT_API void _initExtensions(const asmjit::CpuFeatures& features) noexcept;

  ASMJIT_INLINE_NODEBUG bool is32Bit() const noexcept { return cc->is32Bit(); }
  ASMJIT_INLINE_NODEBUG bool is64Bit() const noexcept { return cc->is64Bit(); }
  ASMJIT_INLINE_NODEBUG uint32_t registerSize() const noexcept { return cc->registerSize(); }

#if defined(ASMJIT_UJIT_X86)
  ASMJIT_INLINE_NODEBUG bool hasGPExt(GPExt ext) const noexcept { return (_gpExtMask & (1u << uint32_t(ext))) != 0; }
  ASMJIT_INLINE_NODEBUG bool hasSSEExt(SSEExt ext) const noexcept { return (_sseExtMask & (1u << uint32_t(ext))) != 0; }
  ASMJIT_INLINE_NODEBUG bool hasAVXExt(AVXExt ext) const noexcept { return (_avxExtMask & (uint64_t(1) << uint32_t(ext))) != 0; }

  //! Tests whether ADX extension is available.
  ASMJIT_INLINE_NODEBUG bool hasADX() const noexcept { return hasGPExt(GPExt::kADX); }
  //! Tests whether BMI extension is available.
  ASMJIT_INLINE_NODEBUG bool hasBMI() const noexcept { return hasGPExt(GPExt::kBMI); }
  //! Tests whether BMI2 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasBMI2() const noexcept { return hasGPExt(GPExt::kBMI2); }
  //! Tests whether LZCNT extension is available.
  ASMJIT_INLINE_NODEBUG bool hasLZCNT() const noexcept { return hasGPExt(GPExt::kLZCNT); }
  //! Tests whether MOVBE extension is available.
  ASMJIT_INLINE_NODEBUG bool hasMOVBE() const noexcept { return hasGPExt(GPExt::kMOVBE); }
  //! Tests whether POPCNT extension is available.
  ASMJIT_INLINE_NODEBUG bool hasPOPCNT() const noexcept { return hasGPExt(GPExt::kPOPCNT); }

  //! Tests whether SSE2 extensions are available (this should always return true).
  ASMJIT_INLINE_NODEBUG bool hasSSE2() const noexcept { return hasSSEExt(SSEExt::kSSE2); }
  //! Tests whether SSE3 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasSSE3() const noexcept { return hasSSEExt(SSEExt::kSSE3); }
  //! Tests whether SSSE3 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasSSSE3() const noexcept { return hasSSEExt(SSEExt::kSSSE3); }
  //! Tests whether SSE4.1 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasSSE4_1() const noexcept { return hasSSEExt(SSEExt::kSSE4_1); }
  //! Tests whether SSE4.2 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasSSE4_2() const noexcept { return hasSSEExt(SSEExt::kSSE4_2); }
  //! Tests whether PCLMULQDQ extension is available.
  ASMJIT_INLINE_NODEBUG bool hasPCLMULQDQ() const noexcept { return hasSSEExt(SSEExt::kPCLMULQDQ); }

  //! Tests whether AVX extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX() const noexcept { return hasAVXExt(AVXExt::kAVX); }
  //! Tests whether AVX2 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX2() const noexcept { return hasAVXExt(AVXExt::kAVX2); }
  //! Tests whether F16C extension is available.
  ASMJIT_INLINE_NODEBUG bool hasF16C() const noexcept { return hasAVXExt(AVXExt::kF16C); }
  //! Tests whether FMA extension is available.
  ASMJIT_INLINE_NODEBUG bool hasFMA() const noexcept { return hasAVXExt(AVXExt::kFMA); }
  //! Tests whether GFNI extension is available.
  ASMJIT_INLINE_NODEBUG bool hasGFNI() const noexcept { return hasAVXExt(AVXExt::kGFNI); }
  //! Tests whether VPCLMULQDQ extension is available.
  ASMJIT_INLINE_NODEBUG bool hasVPCLMULQDQ() const noexcept { return hasAVXExt(AVXExt::kVPCLMULQDQ); }

  //! Tests whether AVX_IFMA extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX_IFMA() const noexcept { return hasAVXExt(AVXExt::kAVX_IFMA); }
  //! Tests whether AVX_NE_CONVERT extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX_NE_CONVERT() const noexcept { return hasAVXExt(AVXExt::kAVX_NE_CONVERT); }
  //! Tests whether AVX_VNNI extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX_VNNI() const noexcept { return hasAVXExt(AVXExt::kAVX_VNNI); }
  //! Tests whether AVX_VNNI_INT8 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX_VNNI_INT8() const noexcept { return hasAVXExt(AVXExt::kAVX_VNNI_INT8); }
  //! Tests whether AVX_VNNI_INT16 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX_VNNI_INT16() const noexcept { return hasAVXExt(AVXExt::kAVX_VNNI_INT16); }

  //! Tests whether a baseline AVX-512 extensions are available (F, CD, BW, DQ, and VL).
  ASMJIT_INLINE_NODEBUG bool hasAVX512() const noexcept { return hasAVXExt(AVXExt::kAVX512); }
  //! Tests whether AVX512_BF16 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX512_BF16() const noexcept { return hasAVXExt(AVXExt::kAVX512_BF16); }
  //! Tests whether AVX512_BITALT extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX512_BITALG() const noexcept { return hasAVXExt(AVXExt::kAVX512_BITALG); }
  //! Tests whether AVX512_FP16 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX512_FP16() const noexcept { return hasAVXExt(AVXExt::kAVX512_FP16); }
  //! Tests whether AVX512_IFMA extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX512_IFMA() const noexcept { return hasAVXExt(AVXExt::kAVX512_IFMA); }
  //! Tests whether AVX512_VBMI extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX512_VBMI() const noexcept { return hasAVXExt(AVXExt::kAVX512_VBMI); }
  //! Tests whether AVX512_VBMI2 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX512_VBMI2() const noexcept { return hasAVXExt(AVXExt::kAVX512_VBMI2); }
  //! Tests whether AVX512_VNNI extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX512_VNNI() const noexcept { return hasAVXExt(AVXExt::kAVX512_VNNI); }
  //! Tests whether AVX512_VPOPCNTDQ extension is available.
  ASMJIT_INLINE_NODEBUG bool hasAVX512_VPOPCNTDQ() const noexcept { return hasAVXExt(AVXExt::kAVX512_VPOPCNTDQ); }

  //! Tests whether the target SIMD ISA provides instructions with non-destructive source operand (AVX+).
  ASMJIT_INLINE_NODEBUG bool hasNonDestructiveSrc() const noexcept { return hasAVX(); }

#endif // ASMJIT_UJIT_X86

#if defined(ASMJIT_UJIT_AARCH64)
  ASMJIT_INLINE_NODEBUG bool hasGPExt(GPExt ext) const noexcept { return (_gpExtMask & (uint64_t(1) << uint32_t(ext))) != 0; }
  ASMJIT_INLINE_NODEBUG bool hasASIMDExt(ASIMDExt ext) const noexcept { return (_asimdExtMask & (uint64_t(1) << uint32_t(ext))) != 0; }

  //! Tests whether CSSC extension is available.
  ASMJIT_INLINE_NODEBUG bool hasCSSC() const noexcept { return hasGPExt(GPExt::kCSSC); }
  //! Tests whether FLAGM extension is available.
  ASMJIT_INLINE_NODEBUG bool hasFLAGM() const noexcept { return hasGPExt(GPExt::kFLAGM); }
  //! Tests whether FLAGM2 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasFLAGM2() const noexcept { return hasGPExt(GPExt::kFLAGM2); }
  //! Tests whether LS64 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasLS64() const noexcept { return hasGPExt(GPExt::kLS64); }
  //! Tests whether LS64_V extension is available.
  ASMJIT_INLINE_NODEBUG bool hasLS64_V() const noexcept { return hasGPExt(GPExt::kLS64_V); }
  //! Tests whether LSE extension is available.
  ASMJIT_INLINE_NODEBUG bool hasLSE() const noexcept { return hasGPExt(GPExt::kLSE); }
  //! Tests whether LSE128 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasLSE128() const noexcept { return hasGPExt(GPExt::kLSE128); }
  //! Tests whether LSE2 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasLSE2() const noexcept { return hasGPExt(GPExt::kLSE2); }

  //! Tests whether ASIMD extension is available (must always return true).
  ASMJIT_INLINE_NODEBUG bool hasASIMD() const noexcept { return hasASIMDExt(ASIMDExt::kASIMD); }
  //! Tests whether BF16 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasBF16() const noexcept { return hasASIMDExt(ASIMDExt::kBF16); }
  //! Tests whether DOTPROD extension is available.
  ASMJIT_INLINE_NODEBUG bool hasDOTPROD() const noexcept { return hasASIMDExt(ASIMDExt::kDOTPROD); }
  //! Tests whether FCMA extension is available.
  ASMJIT_INLINE_NODEBUG bool hasFCMA() const noexcept { return hasASIMDExt(ASIMDExt::kFCMA); }
  //! Tests whether FHM extension is available.
  ASMJIT_INLINE_NODEBUG bool hasFHM() const noexcept { return hasASIMDExt(ASIMDExt::kFHM); }
  //! Tests whether FP16 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasFP16() const noexcept { return hasASIMDExt(ASIMDExt::kFP16); }
  //! Tests whether FP16CONV extension is available.
  ASMJIT_INLINE_NODEBUG bool hasFP16CONV() const noexcept { return hasASIMDExt(ASIMDExt::kFP16CONV); }
  //! Tests whether FP8 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasFP8() const noexcept { return hasASIMDExt(ASIMDExt::kFP8); }
  //! Tests whether FRINTTS extension is available.
  ASMJIT_INLINE_NODEBUG bool hasFRINTTS() const noexcept { return hasASIMDExt(ASIMDExt::kFRINTTS); }
  //! Tests whether I8MM extension is available.
  ASMJIT_INLINE_NODEBUG bool hasI8MM() const noexcept { return hasASIMDExt(ASIMDExt::kI8MM); }
  //! Tests whether JSCVT extension is available.
  ASMJIT_INLINE_NODEBUG bool hasJSCVT() const noexcept { return hasASIMDExt(ASIMDExt::kJSCVT); }
  //! Tests whether PMULL extension is available.
  ASMJIT_INLINE_NODEBUG bool hasPMULL() const noexcept { return hasASIMDExt(ASIMDExt::kPMULL); }
  //! Tests whether RDM extension is available.
  ASMJIT_INLINE_NODEBUG bool hasRDM() const noexcept { return hasASIMDExt(ASIMDExt::kRDM); }
  //! Tests whether SHA1 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasSHA1() const noexcept { return hasASIMDExt(ASIMDExt::kSHA1); }
  //! Tests whether SHA256 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasSHA256() const noexcept { return hasASIMDExt(ASIMDExt::kSHA256); }
  //! Tests whether SHA3 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasSHA3() const noexcept { return hasASIMDExt(ASIMDExt::kSHA3); }
  //! Tests whether SHA512 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasSHA512() const noexcept { return hasASIMDExt(ASIMDExt::kSHA512); }
  //! Tests whether SM3 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasSM3() const noexcept { return hasASIMDExt(ASIMDExt::kSM3); }
  //! Tests whether SM4 extension is available.
  ASMJIT_INLINE_NODEBUG bool hasSM4() const noexcept { return hasASIMDExt(ASIMDExt::kSM4); }

  //! Tests whether the target SIMD ISA provides instructions with non-destructive destination (always on AArch64).
  ASMJIT_INLINE_NODEBUG bool hasNonDestructiveSrc() const noexcept { return true; }

#endif // ASMJIT_UJIT_AARCH64

  //! Returns the behavior of scalar operations (mostly floating point).
  ASMJIT_INLINE_NODEBUG ScalarOpBehavior scalarOpBehavior() const noexcept { return _scalarOpBehavior; }
  //! Returns the behavior of floating point min/max operations.
  ASMJIT_INLINE_NODEBUG FMinMaxOpBehavior fMinMaxOpBehavior() const noexcept { return _fMinMaxOpBehavior; }
  //! Returns the behavior of floating point mul+add (`madd`) operations.
  ASMJIT_INLINE_NODEBUG FMulAddOpBehavior fMulAddOpBehavior() const noexcept { return _fMulAddOpBehavior; }

  //! Tests whether a scalar operation is zeroing the rest of the destination register (AArch64).
  ASMJIT_INLINE_NODEBUG bool isScalarOpZeroing() const noexcept { return _scalarOpBehavior == ScalarOpBehavior::kZeroing; }
  //! Tests whether a scalar operation is preserving the low 128-bit part of the destination register (X86, X86_64).
  ASMJIT_INLINE_NODEBUG bool isScalarOpPreservingVec128() const noexcept { return _scalarOpBehavior == ScalarOpBehavior::kPreservingVec128; }

  //! Tests whether a floating point min/max operation selects a finite value if one of the values is NaN (AArch64).
  ASMJIT_INLINE_NODEBUG bool isFMinMaxFinite() const noexcept { return _fMinMaxOpBehavior == FMinMaxOpBehavior::kFiniteValue; }
  //! Tests whether a floating point min/max operation works as a ternary if - `if a <|> b ? a : b` (X86, X86_64).
  ASMJIT_INLINE_NODEBUG bool isFMinMaxTernary() const noexcept { return _fMinMaxOpBehavior == FMinMaxOpBehavior::kTernaryLogic; }

  //! Tests whether a floating point mul+add operation is fused (uses FMA).
  ASMJIT_INLINE_NODEBUG bool isMAddFused() const noexcept { return _fMulAddOpBehavior != FMulAddOpBehavior::kNoFMA; }
  //! Tests whether a FMA operation is available and that it can store the result to any register (true of X86).
  ASMJIT_INLINE_NODEBUG bool isFMAStoringToAnyRegister() const noexcept { return _fMulAddOpBehavior == FMulAddOpBehavior::kFMAStoreToAny; }
  //! Tests whether a FMA operation is available and that it only stores the result to accumulator register.
  ASMJIT_INLINE_NODEBUG bool isFMAStoringToAccumulator() const noexcept { return _fMulAddOpBehavior == FMulAddOpBehavior::kFMAStoreToAccumulator; }

  ASMJIT_INLINE_NODEBUG UniOptFlags optFlags() const noexcept { return _optFlags; }
  ASMJIT_INLINE_NODEBUG bool hasOptFlag(UniOptFlags flag) const noexcept { return Support::test(_optFlags, flag); }

  //! Returns a native register signature, either 32-bit or 64-bit depending on the target architecture).
  ASMJIT_INLINE_NODEBUG OperandSignature gpSignature() const noexcept { return cc->gpSignature(); }
  ...
  ASMJIT_INLINE_NODEBUG uint32_t vecRegCount() const noexcept { return _vecRegCount; }

  ASMJIT_API VecWidth maxVecWidthFromCpuFeatures() noexcept;
  ASMJIT_API void initVecWidth(VecWidth vw) noexcept;

  ASMJIT_API bool hasMaskedAccessOf(uint32_t dataSize) const noexcept;
  ...
  ASMJIT_INLINE_NODEBUG VecWidth vecWidth() const noexcept { return _vecWidth; }

  //! Returns whether the compiler and all parts use 256-bit SIMD.
  ASMJIT_INLINE_NODEBUG bool use256BitSimd() const noexcept { return _vecWidth >= VecWidth::k256; }
  //! Returns whether the compiler and all parts use 512-bit SIMD.
  ASMJIT_INLINE_NODEBUG bool use512BitSimd() const noexcept { return _vecWidth >= VecWidth::k512; }
  ...
  ASMJIT_INLINE_NODEBUG uint32_t vecMultiplier() const noexcept { return _vecMultiplier; }

  ASMJIT_INLINE_NODEBUG VecWidth vecWidthOf(DataWidth dataWidth, uint32_t n) const noexcept { return VecWidthUtils::vecWidthOf(vecWidth(), dataWidth, n); }
  ...
  ASMJIT_API void initFunction(asmjit::FuncNode* funcNode) noexcept;
  ...
  ASMJIT_INLINE void rename(const OpArray& opArray, const char* name) noexcept {
    for (uint32_t i = 0; i < opArray.size(); i++)
      cc->rename(opArray[i].as<asmjit::BaseReg>(), "%s%u", name, unsigned(i));
  }

  ASMJIT_INLINE void rename(const OpArray& opArray, const char* prefix, const char* name) noexcept {
    for (uint32_t i = 0; i < opArray.size(); i++)
  ...
  ASMJIT_INLINE Label newLabel() const noexcept { return cc->newLabel(); }

  ASMJIT_INLINE void align(AlignMode alignMode, uint32_t alignment) noexcept { cc->align(alignMode, alignment); }
  ...
  ASMJIT_INLINE Gp newGp32() noexcept { return cc->newUInt32(); }
  ASMJIT_INLINE Gp newGp64() noexcept { return cc->newUInt64(); }
  ASMJIT_INLINE Gp newGpPtr() noexcept { return cc->newUIntPtr(); }

  template<typename... Args>
  ASMJIT_INLINE Gp newGp32(const char* name, Args&&... args) noexcept { return cc->newUInt32(name, std::forward<Args>(args)...); }
  template<typename... Args>
  ASMJIT_INLINE Gp newGp64(const char* name, Args&&... args) noexcept { return cc->newUInt64(name, std::forward<Args>(args)...); }
  template<typename... Args>
  ASMJIT_INLINE Gp newGpPtr(const char* name, Args&&... args) noexcept { return cc->newUIntPtr(name, std::forward<Args>(args)...); }

  template<typename RegT>
  ASMJIT_INLINE RegT newSimilarReg(const RegT& ref) noexcept { return cc->newSimilarReg(ref); }
  template<typename RegT, typename... Args>
  ASMJIT_INLINE RegT newSimilarReg(const RegT& ref, Args&&... args) noexcept { return cc->newSimilarReg(ref, std::forward<Args>(args)...); }

  template<typename... Args>
  ASMJIT_INLINE Vec newVec(const char* name, Args&&... args) noexcept {
    Vec reg;
  ...
  template<typename... Args>
  ASMJIT_INLINE Vec newVec(VecWidth vw, const char* name, Args&&... args) noexcept {
    Vec reg;
    cc->_newRegFmt(&reg, VecWidthUtils::typeIdOf(vw), name, std::forward<Args>(args)...);
    return reg;
  }

  ASMJIT_NOINLINE void newRegArray(OpArray& dst, uint32_t n, asmjit::TypeId typeId, const char* name) noexcept {
  ...
  ASMJIT_NOINLINE void newRegArray(OpArray& dst, uint32_t n, asmjit::TypeId typeId, const char* prefix, const char* name) noexcept {
    ASMJIT_ASSERT(n <= OpArray::kMaxSize);
    dst._size = n;
    for (uint32_t i = 0; i < n; i++) {
  ...
  ASMJIT_NOINLINE void newRegArray(OpArray& dst, uint32_t n, const asmjit::BaseReg& ref, const char* name) noexcept {
    ASMJIT_ASSERT(n <= OpArray::kMaxSize);
    dst._size = n;
    for (uint32_t i = 0; i < n; i++) {
  ...
  ASMJIT_NOINLINE void newRegArray(OpArray& dst, uint32_t n, const asmjit::BaseReg& ref, const char* prefix, const char* name) noexcept {
    ASMJIT_ASSERT(n <= OpArray::kMaxSize);
    dst._size = n;
    for (uint32_t i = 0; i < n; i++) {
  ...
  ASMJIT_INLINE void newVecArray(OpArray& dst, uint32_t n, VecWidth vw, const char* name) noexcept {
    newRegArray(dst, n, VecWidthUtils::typeIdOf(vw), name);
  }

  ASMJIT_INLINE void newVecArray(OpArray& dst, uint32_t n, VecWidth vw, const char* prefix, const char* name) noexcept {
    newRegArray(dst, n, VecWidthUtils::typeIdOf(vw), prefix, name);
  }

  ASMJIT_INLINE void newVecArray(OpArray& dst, uint32_t n, const Vec& ref, const char* name) noexcept {
    newRegArray(dst, n, ref, name);
  }

  ASMJIT_INLINE void newVecArray(OpArray& dst, uint32_t n, const Vec& ref, const char* prefix, const char* name) noexcept {
    newRegArray(dst, n, ref, prefix, name);
  }

  ASMJIT_API Mem tmpStack(StackId id, uint32_t size) noexcept;
  ...
  ASMJIT_API void embedJumpTable(const Label* jumpTable, size_t jumpTableSize, const Label& jumpTableBase, uint32_t entrySize) noexcept;

  //! \}

  ASMJIT_API void _initVecConstTablePtr() noexcept;
  ...
  ASMJIT_INLINE Vec newV128() noexcept {
    Vec reg;
    cc->_newReg(&reg, asmjit::TypeId::kInt32x4);
    return reg;
  }

  ASMJIT_INLINE Vec newV32_F32() noexcept {
    Vec reg;
    cc->_newReg(&reg, asmjit::TypeId::kFloat32x1);
    return reg;
  }

  ASMJIT_INLINE Vec newV64_F64() noexcept {
    Vec reg;
    cc->_newReg(&reg, asmjit::TypeId::kFloat64x1);
    return reg;
  }

  ASMJIT_INLINE Vec newV128_F32() noexcept {
    Vec reg;
    cc->_newReg(&reg, asmjit::TypeId::kFloat32x4);
    return reg;
  }

  ASMJIT_INLINE Vec newV128_F64() noexcept {
    Vec reg;
  ...
  template<typename... Args>
  ASMJIT_INLINE Vec newV128(Args&&... args) noexcept {
    Vec reg;
  ...
  template<typename... Args>
  ASMJIT_INLINE Vec newV32_F32(Args&&... args) noexcept {
    Vec reg;
  ...
  template<typename... Args>
  ASMJIT_INLINE Vec newV64_F64(Args&&... args) noexcept {
    Vec reg;
  ...
  template<typename... Args>
  ASMJIT_INLINE Vec newV128_F32(Args&&... args) noexcept {
    Vec reg;
  ...
  template<typename... Args>
  ASMJIT_INLINE Vec newV128_F64(Args&&... args) noexcept {
    Vec reg;
    cc->_newRegFmt(&reg, asmjit::TypeId::kFloat64x2, std::forward<Args>(args)...);
    return reg;
  }

  ASMJIT_INLINE void newV128Array(OpArray& dst, uint32_t n, const char* name) noexcept {
    newRegArray(dst, n, asmjit::TypeId::kInt32x4, name);
  }

  ASMJIT_INLINE void newV128Array(OpArray& dst, uint32_t n, const char* prefix, const char* name) noexcept {
    newRegArray(dst, n, asmjit::TypeId::kInt32x4, prefix, name);
  }

  template<typename... Args>
  ASMJIT_INLINE Vec newV256(const char* name, Args&&... args) noexcept {
    Vec reg;
    cc->_newRegFmt(&reg, asmjit::TypeId::kInt32x8, name, std::forward<Args>(args)...);
    return reg;
  }

  ASMJIT_INLINE void newV256Array(OpArray& dst, uint32_t n, const char* name) noexcept {
    newRegArray(dst, n, asmjit::TypeId::kInt32x8, name);
  }

  ASMJIT_INLINE void newV256Array(OpArray& dst, uint32_t n, const char* prefix, const char* name) noexcept {
    newRegArray(dst, n, asmjit::TypeId::kInt32x8, prefix, name);
  }

  template<typename... Args>
  ASMJIT_INLINE Vec newV512(const char* name, Args&&... args) noexcept {
    Vec reg;
    cc->_newRegFmt(&reg, asmjit::TypeId::kInt32x16, name, std::forward<Args>(args)...);
    return reg;
  }

  ASMJIT_INLINE void newV512Array(OpArray& dst, uint32_t n, const char* name) noexcept {
    newRegArray(dst, n, asmjit::TypeId::kInt32x16, name);
  }

  ASMJIT_INLINE void newV512Array(OpArray& dst, uint32_t n, const char* prefix, const char* name) noexcept {
  ...
  template<typename... Args>
  ASMJIT_INLINE Vec newV128(const char* name, Args&&... args) noexcept {
    Vec reg;
  ...
  template<typename... Args>
  ASMJIT_INLINE Vec newV32_F32(const char* name, Args&&... args) noexcept {
    Vec reg;
  ...
  template<typename... Args>
  ASMJIT_INLINE Vec newV64_F64(const char* name, Args&&... args) noexcept {
    Vec reg;
  ...
  template<typename... Args>
  ASMJIT_INLINE Vec newV128_F32(const char* name, Args&&... args) noexcept {
    Vec reg;
  ...
  template<typename... Args>
  ASMJIT_INLINE Vec newV128_F64(const char* name, Args&&... args) noexcept {
    Vec reg;
...
#if defined(ASMJIT_UJIT_X86)
  ASMJIT_API x86::KReg kConst(uint64_t value) noexcept;
#endif // ASMJIT_UJIT_X86

  ASMJIT_API Operand simdConst(const void* c, Bcst bcstWidth, VecWidth constWidth) noexcept;
  ASMJIT_API Operand simdConst(const void* c, Bcst bcstWidth, const Vec& similarTo) noexcept;
  ASMJIT_API Operand simdConst(const void* c, Bcst bcstWidth, const VecArray& similarTo) noexcept;

  ASMJIT_API Vec simdVecConst(const void* c, Bcst bcstWidth, VecWidth constWidth) noexcept;
  ASMJIT_API Vec simdVecConst(const void* c, Bcst bcstWidth, const Vec& similarTo) noexcept;
  ASMJIT_API Vec simdVecConst(const void* c, Bcst bcstWidth, const VecArray& similarTo) noexcept;

  ASMJIT_API Mem simdMemConst(const void* c, Bcst bcstWidth, VecWidth constWidth) noexcept;
  ASMJIT_API Mem simdMemConst(const void* c, Bcst bcstWidth, const Vec& similarTo) noexcept;
  ASMJIT_API Mem simdMemConst(const void* c, Bcst bcstWidth, const VecArray& similarTo) noexcept;

  ASMJIT_API Mem _getMemConst(const void* c) noexcept;
  ASMJIT_API Vec _newVecConst(const void* c, bool isUniqueConst) noexcept;

#if defined(ASMJIT_UJIT_AARCH64)
  ASMJIT_API Vec simdConst16B(const void* data16) noexcept;
#endif // ASMJIT_UJIT_AARCH64

#if defined(ASMJIT_UJIT_AARCH64)
  inline Vec simdVecZero(const Vec& similarTo) noexcept { return simdVecConst(&ct.p_0000000000000000, Bcst::k32, similarTo); }
#endif // ASMJIT_UJIT_AARCH64
...
#if 1
  inline void i_prefetch(const Mem& mem) noexcept { DebugUtils::unused(mem); }
#else
  ...
  ASMJIT_API void emit_vm(UniOpVM op, const Vec& dst_, const Mem& src_, uint32_t alignment, uint32_t idx = 0) noexcept;
  ASMJIT_API void emit_vm(UniOpVM op, const OpArray& dst_, const Mem& src_, uint32_t alignment, uint32_t idx = 0) noexcept;

  ASMJIT_API void emit_mv(UniOpMV op, const Mem& dst_, const Vec& src_, uint32_t alignment, uint32_t idx = 0) noexcept;
  ASMJIT_API void emit_mv(UniOpMV op, const Mem& dst_, const OpArray& src_, uint32_t alignment, uint32_t idx = 0) noexcept;
  ...
  #define DEFINE_OP_VM_U(name, op, alignment) \
    ASMJIT_INLINE void name(const Vec& dst, const Mem& src) noexcept { emit_vm(op, dst, src, alignment); } \
    ASMJIT_INLINE void name(const VecArray& dst, const Mem& src) noexcept { emit_vm(op, dst, src, alignment); }

  #define DEFINE_OP_VM_A(name, op, default_alignment) \
    ASMJIT_INLINE void name(const Vec& dst, const Mem& src, Alignment alignment = Alignment{default_alignment}) noexcept { emit_vm(op, dst, src, alignment._v); } \
    ASMJIT_INLINE void name(const VecArray& dst, const Mem& src, Alignment alignment = Alignment{default_alignment}) noexcept { emit_vm(op, dst, src, alignment._v); }

  #define DEFINE_OP_VM_I(name, op, default_alignment) \
    ASMJIT_INLINE void name(const Vec& dst, const Mem& src, uint32_t idx) noexcept { emit_vm(op, dst, src, default_alignment, idx); } \
    ASMJIT_INLINE void name(const VecArray& dst, const Mem& src, uint32_t idx) noexcept { emit_vm(op, dst, src, default_alignment, idx); }

  #define DEFINE_OP_MV_U(name, op, alignment) \
    ASMJIT_INLINE void name(const Mem& dst, const Vec& src) noexcept { emit_mv(op, dst, src, alignment); } \
    ASMJIT_INLINE void name(const Mem& dst, const VecArray& src) noexcept { emit_mv(op, dst, src, alignment); }

  #define DEFINE_OP_MV_A(name, op, default_alignment) \
    ASMJIT_INLINE void name(const Mem& dst, const Vec& src, Alignment alignment = Alignment{default_alignment}) noexcept { emit_mv(op, dst, src, alignment._v); } \
    ASMJIT_INLINE void name(const Mem& dst, const VecArray& src, Alignment alignment = Alignment{default_alignment}) noexcept { emit_mv(op, dst, src, alignment._v); }

  #define DEFINE_OP_MV_I(name, op, default_alignment) \
    ASMJIT_INLINE void name(const Mem& dst, const Vec& src, uint32_t idx) noexcept { emit_mv(op, dst, src, default_alignment, idx); } \
    ASMJIT_INLINE void name(const Mem& dst, const VecArray& src, uint32_t idx) noexcept { emit_mv(op, dst, src, default_alignment, idx); }
  ...
  ASMJIT_NOINLINE void v_load_iany(const Vec& dst, const Mem& src, uint32_t nBytes, Alignment alignment) noexcept {
    switch (nBytes) {
  ...
  ASMJIT_NOINLINE void v_store_iany(const Mem& dst, const Vec& src, uint32_t nBytes, Alignment alignment) noexcept {
    switch (nBytes) {
  ...
  template<typename Dst, typename Src>
  ASMJIT_INLINE void shiftOrRotateLeft(const Dst& dst, const Src& src, uint32_t n) noexcept {
  #if defined(ASMJIT_UJIT_X86)
    if ((n & 3) == 0)
  ...
  template<typename Dst, typename Src>
  ASMJIT_INLINE void shiftOrRotateRight(const Dst& dst, const Src& src, uint32_t n) noexcept {
  #if defined(ASMJIT_UJIT_X86)
    if ((n & 3) == 0)
...
public:
  ...
  ASMJIT_INLINE PipeInjectAtTheEnd(UniCompiler* pc) noexcept
